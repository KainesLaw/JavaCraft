...
public class Main {
  public static void main(String[] args) {
    ...
    // }
    clear();
    type("Welcome to JavaCraft! This game is a Minecraft clone\nusing ASCII. I hope you like it! Once you start the game, you will see options below the game. Using those options, you can play the game! Well, that's all I have to say! Press enter to start the game.", "orange");
    scan.nextLine();
    for (int c = 0; c < 75; c++) {
